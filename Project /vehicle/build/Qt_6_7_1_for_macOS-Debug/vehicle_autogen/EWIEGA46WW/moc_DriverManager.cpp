...
struct qt_meta_stringdata_CLASSDriverManagerENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSDriverManagerENDCLASS = QtMocHelpers::stringData(
    "DriverManager"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSDriverManagerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject DriverManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSDriverManagerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSDriverManagerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDriverManagerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *DriverManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSDriverManagerENDCLASS.stringdata0))
